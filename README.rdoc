...
As of 2.5.2.devel of this plugin, Redmine 2.5.2 or greater is required, Rails 2.3.2 (onwards), with test-cases requiring libxml-ruby Gem.
...
3. <tt>git clone git://github.com/odoral/redmine_mylyn_connector.git</tt>
4. <tt>cd ..</tt>
